!function () {
    ...
    class n {
        ...
        onWindowResize() {
            const e = document.documentElement.clientWidth, t = window.innerHeight, n = this.previousWidth !== e,
    ...
    !function () {
        ...
        const t = [], n = new IntersectionObserver((e => {
            e.forEach((e => {
        ...
        e.forEach((e => {
            ...
            const o = {}, {maybeResetVideoProgress: i, videoStart: a} = function (e, t) {
                const n = e.dataset.trimStartUs, o = e.dataset.trimEndUs, i = null != n ? parseFloat(n) / 1e6 : 0;
            ...
            const s = function (e, t, n, o) {
                ...
                const {seekBar: l, updateDuration: c} = function (e) {
                    ...
                    return e.addEventListener("timeupdate", (() => {
                        ...
                        const t = a - i, n = Math.min((e.currentTime - i) / t * 100, 100);
                        s.style.width = `${n}%`
                    })), {seekBar: n, updateDuration: r}
                }(e);
                o.updateDuration = c, d.appendChild(l), function (e, t) {
                ...
                const {playButton: u, playPause: p} = function (e, t) {
                    ...
                    const i = o.content.firstChild.cloneNode(!0),
                        a = Number.parseFloat(e.getAttribute("data-volume") || "1"), r = async o => {
                            if (n) return;
                    ...
                    return i.addEventListener("click", r), {playButton: i, playPause: r}
                }(e, t);
                d.appendChild(u);
                const v = u.querySelector(".pauseSvg"), h = u.querySelector(".playSvg"), m = () => {
            ...
            !function (e) {
                ...
                const o = n.split(", ").map((e => e.split(" "))).map((([e, t]) => ({url: e, width: t}))),
                    i = e.getAttribute("data-sizes") || "", a = i.split(", ").map((e => {
                        const t = e.lastIndexOf(" ");
                        return {media: e.substring(0, t), width: e.substring(t, e.length)}
                    }));
                let r;
                for (const e of a) if (window.matchMedia(e.media).matches) {
